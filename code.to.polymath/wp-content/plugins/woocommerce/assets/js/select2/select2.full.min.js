...
! function(e) {
    ...
    (u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) && u.requirejs || (u ? e = u : u = {}, f = {}, g = {}, m = {}, y = {}, n = Object.prototype.hasOwnProperty, i = [].slice, v = /\.js$/, p = function(e, t) {
            var n, i, o = c(e),
                s = o[0];
            ...
            return r(e)
        }, o._defined = f, (a = function(e, t, n) {
            if ("string" != typeof e) throw new Error("See almond README: incorrect module build, no module name");
            t.splice || (n = t, t = []), _(f, e) || _(g, e) || (g[e] = [e, t, n])
        }).amd = {
            jQuery: !0
        }, u.requirejs = o, u.require = e, u.define = a), u.define("almond", function() {}), u.define("jquery", [], function() {
            var e = t || $;
            ...
            return e.Extend(i, e.Observable), i.prototype.render = function() {
                ...
                var t = this.options.get("escapeMarkup"),
                    n = (this.clear(), this.hideLoading(), d('<li role="treeitem" aria-live="assertive" class="select2-results__option"></li>')),
                ...
                var t, n = document.createElement("li"),
                    i = (n.className = "select2-results__option", {
                        role: "treeitem",
                        "aria-selected": "false"
                    });
                for (t in e.disabled && (delete i["aria-selected"], i["aria-disabled"] = "true"), null == e.id && delete i["aria-selected"], null != e._resultId && (n.id = e._resultId), e.title && (n.title = e.title), e.children && (i.role = "group", i["aria-label"] = e.text, delete i["aria-selected"]), i) {
                    var o = i[t];
                    n.setAttribute(t, o)
                }
                if (e.children) {
                    for (var s = d(n), r = document.createElement("strong"), a = (r.className = "select2-results__group", d(r), this.template(e, r), []), l = 0; l < e.children.length; l++) {
                        var c = e.children[l],
                            c = this.option(c);
                        a.push(c)
                    }
                ...
                this.$results.attr("id", n), t.on("results:all", function(e) {
                    ...
                    var e, t = o.getHighlightedResults(),
                        ...
                        i = n.index(t);
                    0 !== i && (i = i - 1, 0 === t.length && (i = 0), (t = n.eq(i)).trigger("mouseenter"), n = o.$results.offset().top, t = t.offset().top, e = o.$results.scrollTop() + (t - n), 0 === i ? o.$results.scrollTop(0) : t - n < 0 && o.$results.scrollTop(e))
                }), t.on("results:next", function() {
                    var e, t, n = o.getHighlightedResults(),
                        i = o.$results.find("[aria-selected]"),
                        n = i.index(n) + 1;
                    n >= i.length || ((i = i.eq(n)).trigger("mouseenter"), e = o.$results.offset().top + o.$results.outerHeight(!1), i = i.offset().top + i.outerHeight(!1), t = o.$results.scrollTop() + i - e, 0 === n ? o.$results.scrollTop(0) : e < i && o.$results.scrollTop(t))
                    ...
                    var t = d(this),
                        n = t.data("data");
                    "true" === t.attr("aria-selected") ? o.options.get("multiple") ? o.trigger("unselect", {
                        originalEvent: e,
                        data: n
                ...
                0 !== o.length && (e = this.$results.find("[aria-selected]").index(o), t = this.$results.offset().top, i = o.offset().top, n = this.$results.scrollTop() + (i - t), i = i - t, n -= 2 * o.outerHeight(!1), e <= 2 ? this.$results.scrollTop(0) : (i > this.$results.outerHeight() || i < 0) && this.$results.scrollTop(n))
            ...
            return n.Extend(o, t), o.prototype.render = function() {
                ...
                var n = this,
                    i = (o.__super__.bind.apply(this, arguments), t.id + "-container");
                ...
                var t, n;
                0 === e.length ? this.clear() : (e = e[0], t = this.$selection.find(".select2-selection__rendered"), n = this.display(e, t), t.empty().append(n), t.prop("title", e.title || e.text))
            }, o
            ...
            return t.prototype.render = function(e) {
                ...
                var i = this,
                    n = (e.call(this, t, n), t.on("open", function() {
            ...
            return c.Extend(i, e), i.prototype.select = function(n) {
                ...
                for (var s = 0; s < e.length; s++) {
                    ...
                    }(l)), r = this.item(a), r = u.extend(!0, {}, l, r), r = this.option(r), a.replaceWith(r)) : (r = this.option(l), l.children && (a = this.convertToOptions(l.children), c.appendMany(r, a)), o.push(r))
                }
                return o
            }, i
            ...
            return t.Extend(n, e), n.prototype._applyDefaults = function(e) {
                ...
                var i = this,
                    o = (null != this._request && (s.isFunction(this._request.abort) && this._request.abort(), this._request = null), s.extend({
                        type: "GET"
                    }, this.ajaxOptions));
            ...
            return e.prototype.query = function(e, l, c) {
                var u = this;
                this._removeOldTags(), null == l.term || null != l.page ? e.call(this, l, c) : e.call(this, l, function d(e, t) {
            ...
            return e.prototype.bind = function(e, t, n) {
                ...
                for (var o = n.get("tokenSeparators") || [], s = t.term, r = 0, a = this.createTag || function(e) {
                    ...
                    var l = s[r]; - 1 === c.inArray(l, o) ? r++ : (l = s.substr(0, r), null == (l = a(c.extend({}, t, {
                        term: l
                    }))) ? r++ : (i(l), s = s.substr(r + 1) || "", r = 0))
                }
                return {
                    term: s
                }
            ...
            return t.prototype.render = function(e) {
                var e = e.call(this),
                    t = o('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox" /></span>');
            ...
            return e.prototype.bind = function(e, t, n) {
                ...
                var e = c(window),
                    ...
                    s = (o.bottom = o.top + this.$container.outerHeight(!1), {
                ...
                o.top -= l.top, o.left -= l.left, t || n || (i = "below"), e || !a || t ? !a && e && t && (i = "below") : i = "above", ("above" == i || t && "below" !== i) && (o.top = s.top - l.top - r), null != i && (this.$dropdown.removeClass("select2-dropdown--below select2-dropdown--above").addClass("select2-dropdown--" + i), this.$container.removeClass("select2-container--below select2-container--above").addClass("select2-container--" + i)), this.$dropdownContainer.css(o)
                ...
                if (null == (e = u.extend(!0, {}, this.defaults, e)).dataAdapter && (null != e.ajax ? e.dataAdapter = x : null != e.data ? e.dataAdapter = b : e.dataAdapter = $, 0 < e.minimumInputLength && (e.dataAdapter = _.Decorate(e.dataAdapter, S)), 0 < e.maximumInputLength && (e.dataAdapter = _.Decorate(e.dataAdapter, O)), 0 < e.maximumSelectionLength && (e.dataAdapter = _.Decorate(e.dataAdapter, E)), e.tags && (e.dataAdapter = _.Decorate(e.dataAdapter, A)), null == e.tokenSeparators && null == e.tokenizer || (e.dataAdapter = _.Decorate(e.dataAdapter, C)), null != e.query && (r = d(e.amdBase + "compat/query"), e.dataAdapter = _.Decorate(e.dataAdapter, r)), null != e.initSelection && (r = d(e.amdBase + "compat/initSelection"), e.dataAdapter = _.Decorate(e.dataAdapter, r))), null == e.resultsAdapter && (e.resultsAdapter = p, null != e.ajax && (e.resultsAdapter = _.Decorate(e.resultsAdapter, j)), null != e.placeholder && (e.resultsAdapter = _.Decorate(e.resultsAdapter, q)), e.selectOnClose && (e.resultsAdapter = _.Decorate(e.resultsAdapter, P))), null == e.dropdownAdapter && (e.multiple ? e.dropdownAdapter = D : (r = _.Decorate(D, T), e.dropdownAdapter = r), 0 !== e.minimumResultsForSearch && (e.dropdownAdapter = _.Decorate(e.dropdownAdapter, k)), e.closeOnSelect && (e.dropdownAdapter = _.Decorate(e.dropdownAdapter, I)), null == e.dropdownCssClass && null == e.dropdownCss && null == e.adaptDropdownCssClass || (r = d(e.amdBase + "compat/dropdownCss"), e.dropdownAdapter = _.Decorate(e.dropdownAdapter, r)), e.dropdownAdapter = _.Decorate(e.dropdownAdapter, L)), null == e.selectionAdapter && (e.multiple ? e.selectionAdapter = f : e.selectionAdapter = h, null != e.placeholder && (e.selectionAdapter = _.Decorate(e.selectionAdapter, g)), e.allowClear && (e.selectionAdapter = _.Decorate(e.selectionAdapter, m)), e.multiple && (e.selectionAdapter = _.Decorate(e.selectionAdapter, y)), null == e.containerCssClass && null == e.containerCss && null == e.adaptContainerCssClass || (r = d(e.amdBase + "compat/containerCss"), e.selectionAdapter = _.Decorate(e.selectionAdapter, r)), e.selectionAdapter = _.Decorate(e.selectionAdapter, v)), "string" == typeof e.language && (0 < e.language.indexOf("-") ? (r = e.language.split("-")[0], e.language = [e.language, r]) : e.language = [e.language]), u.isArray(e.language)) {
                    for (var t = new w, n = (e.language.push("en"), e.language), i = 0; i < n.length; i++) {
                        ...
                        try {
                            ...
                            try {
                                o = this.defaults.amdLanguageBase + o, s = w.loadPath(o)
                            } catch (c) {
                                e.debug && window.console && console.warn && console.warn('Select2: The language file for "' + o + '" could not be automatically loaded. A fallback will be used instead.');
                                continue
                            }
                        }
                        t.extend(s)
                ...
                this.defaults = {
                    ...
                    matcher: function a(e, t) {
                        ...
                        if (t.children && 0 < t.children.length) {
                            for (var n = u.extend(!0, {}, t), i = t.children.length - 1; 0 <= i; i--) null == a(e, t.children[i]) && n.children.splice(i, 1);
            ...
            function e(e, t) {
                this.options = e, null != t && this.fromElement(t), this.options = i.apply(this.options), t && t.is("input") && (e = n(this.get("amdBase") + "compat/inputData"), this.options.dataAdapter = r.Decorate(this.options.dataAdapter, e))
            }
            return e.prototype.fromElement = function(e) {
                var t, n = ["select2"],
                    i = (null == this.options.multiple && (this.options.multiple = e.prop("multiple")), null == this.options.disabled && (this.options.disabled = e.prop("disabled")), null == this.options.language && (e.prop("lang") ? this.options.language = e.prop("lang").toLowerCase() : e.closest("[lang]").prop("lang") && (this.options.language = e.closest("[lang]").prop("lang"))), null == this.options.dir && (e.prop("dir") ? this.options.dir = e.prop("dir") : e.closest("[dir]").prop("dir") ? this.options.dir = e.closest("[dir]").prop("dir") : this.options.dir = "ltr"), e.prop("disabled", this.options.disabled), e.prop("multiple", this.options.multiple), e.data("select2Tags") && (this.options.debug && window.console && console.warn && console.warn('Select2: The `data-select2-tags` attribute has been changed to use the `data-data` and `data-tags="true"` attributes and will be removed in future versions of Select2.'), e.data("data", e.data("select2Tags")), e.data("tags", !0)), e.data("ajaxUrl") && (this.options.debug && window.console && console.warn && console.warn("Select2: The `data-ajax-url` attribute has been changed to `data-ajax--url` and support for the old attribute will be removed in future versions of Select2."), e.attr("ajax--url", e.data("ajaxUrl")), e.data("ajax--url", e.data("ajaxUrl"))), {}),
                    i = s.fn.jquery && "1." == s.fn.jquery.substr(0, 2) && e[0].dataset ? s.extend(!0, {}, e[0].dataset, e.data()) : e.data(),
                    o = s.extend(!0, {}, i);
                for (t in o = r._convertData(o)) - 1 < s.inArray(t, n) || (s.isPlainObject(this.options[t]) ? s.extend(this.options[t], o[t]) : this.options[t] = o[t]);
                return this
            ...
            var r = function(e, t) {
                ...
                var t = e.attr("tabindex") || 0,
                    ...
                    i = (this.results = new n(e, this.options, this.dataAdapter), this.$results = this.results.render(), this.results.position(this.$results, this.$dropdown), this);
            ...
            return e.prototype.render = function(e) {
                var n, e = e.call(this),
                    ...
                    i = (s.isFunction(t) && (t = t(this.$element)), this.options.get("adaptContainerCssClass")),
                    o = (i = i || a, -1 !== t.indexOf(":all:") && (t = t.replace(":all:", ""), n = i, i = function(e) {
                        var t = n(e);
                        return null != t ? t + " " + e : e
                    }), this.options.get("containerCss") || {});
                return s.isFunction(o) && (o = o(this.$element)), r.syncCssClasses(e, this.$element, i), e.css(o), e.addClass(t), e
            }, e
            ...
            return e.prototype.render = function(e) {
                var n, e = e.call(this),
                    ...
                    i = (s.isFunction(t) && (t = t(this.$element)), this.options.get("adaptDropdownCssClass")),
                    o = (i = i || a, -1 !== t.indexOf(":all:") && (t = t.replace(":all:", ""), n = i, i = function(e) {
                        var t = n(e);
                        return null != t ? t + " " + e : e
        ...
        o = function(c) {
            ...
            function i(e) {
                var t, n = e || window.event,
                    ...
                    a = 0,
                    l = 0;
                if ((e = c.event.fix(n)).type = "mousewheel", "detail" in n && (r = -1 * n.detail), "wheelDelta" in n && (r = n.wheelDelta), "wheelDeltaY" in n && (r = n.wheelDeltaY), "wheelDeltaX" in n && (s = -1 * n.wheelDeltaX), "axis" in n && n.axis === n.HORIZONTAL_AXIS && (s = -1 * r, r = 0), o = 0 === r ? s : r, "deltaY" in n && (o = r = -1 * n.deltaY), "deltaX" in n && (s = n.deltaX, 0 === r && (o = -1 * s)), 0 !== r || 0 !== s) return 1 === n.deltaMode ? (o *= t = c.data(this, "mousewheel-line-height"), r *= t, s *= t) : 2 === n.deltaMode && (o *= t = c.data(this, "mousewheel-page-height"), r *= t, s *= t), t = Math.max(Math.abs(r), Math.abs(s)), (!d || t < d) && g(n, d = t) && (d /= 40), g(n, t) && (o /= 40, s /= 40, r /= 40), o = Math[1 <= o ? "floor" : "ceil"](o / d), s = Math[1 <= s ? "floor" : "ceil"](s / d), r = Math[1 <= r ? "floor" : "ceil"](r / d), h.settings.normalizeOffset && this.getBoundingClientRect && (n = this.getBoundingClientRect(), a = e.clientX - n.left, l = e.clientY - n.top), e.deltaX = s, e.deltaY = r, e.deltaFactor = d, e.offsetX = a, e.offsetY = l, e.deltaMode = 0, i.unshift(e, o, s, r), u && clearTimeout(u), u = setTimeout(f, 200), (c.event.dispatch || c.event.handle).apply(this, i)
            }
        ...
        }, "function" == typeof u.define && u.define.amd ? u.define("jquery-mousewheel", ["jquery"], o) : "object" == typeof exports ? module.exports = o : o(t), u.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults"], function(o, e, s, t) {
            var r;
            return null == o.fn.select2 && (r = ["open", "close", "destroy"], o.fn.select2 = function(t) {
                ...
                var n, i;
                if ("string" == typeof t) return i = Array.prototype.slice.call(arguments, 1), this.each(function() {
    ...
    var e, d, s, r, p, h, f, g, m, y, n, i, v, o, a = {
        define: u.define,
        require: u.require
    };
    ...
    function b(e) {
        var t;
        if (_(g, e) && (t = g[e], delete g[e], y[e] = !0, s.apply(d, t)), _(f, e) || _(y, e)) return f[e];
