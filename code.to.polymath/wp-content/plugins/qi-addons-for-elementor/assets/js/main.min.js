! function(d) {
    ...
    var x = {
        ...
        initSlider: function(o) {
            ...
            }, 200) : new Swiper(o, Object.assign(n, i)), elementorFrontend.isEditMode() && elementor.channels.editor.on("change", function() {
                o[0].swiper.update()
            })
        },
        getOptions: function(e) {
            var o = void 0 !== e.data("options") ? e.data("options") : {},
                ...
                g = p ? ".swiper-button-next-" + o.unique : e.find(".swiper-button-next"),
                v = p ? ".swiper-button-prev-" + o.unique : e.find(".swiper-button-prev"),
                w = void 0 !== o.outsidePagination && "yes" === o.outsidePagination ? ".swiper-pagination-" + o.unique : e.find(".swiper-pagination"),
                b = "horizontal" === o.direction;
            !1 !== u && 5e3 !== q ? u = {
                delay: q,
            ...
            var p = void 0 !== o.slidesPerView1440 && "" !== o.slidesPerView1440 ? parseInt(o.slidesPerView1440, 10) + n : "auto" === o.slidesPerView ? "auto" : 5 + n,
                q = void 0 !== o.slidesPerView1366 && "" !== o.slidesPerView1366 ? parseInt(o.slidesPerView1366, 10) + n : "auto" === o.slidesPerView ? "auto" : 4 + n,
            ...
            if (m || (s < 2 ? y = C = q = p = s : s < 3 ? C = q = p = s : s < 4 ? q = p = s : s < 5 && (p = s)), "never" !== i) switch (i) {
                case 1024:
                    C = Math.floor(C);
                case 768:
                    y = Math.floor(y);
    ...
    qodefAddonsCore.qodefSwiper = x, "function" != typeof Object.assign && (Object.assign = function(e) {
    ...
    var o = {
        init: function() {
            this.holder = d(".qodef-qi--has-appear:not(.qodef-qi--appeared)"), this.holder.length && this.holder.each(function() {
                var e, o = d(this),
                    t = (t = 10, e = 400, Math.floor(Math.random() * (e - t) + t)),
    ...
    qodefAddonsCore.qodefScroll = n, qodefAddonsCore.qodefSwiperElementorCheck = {
        init: function(o, t) {
...
function(e) {
    ...
    var o = {
        ...
        generateChartData: function(i) {
            ...
            }), y || (w = i.find("canvas"), A = new Chart(w, I))
        }
    };
...
function(n) {
    "use strict";
    qodefAddonsCore.shortcodes.qi_addons_for_elementor_device_carousel = {}, n(document).ready(function() {
        e.init()
    });
    var e = {
        init: function() {
            this.sliders = n(".qodef-qi-device-carousel"), this.sliders.length && this.sliders.each(function() {
                e.initItem(n(this))
            })
        },
        initItem: function(o) {
            var t = setInterval(function() {
                if (o.children(".qodef-qi-swiper-container").hasClass("qodef-swiper--initialized")) {
                    const e = o.find(".qodef-device-carousel-device .qodef-qi-swiper-container");
                    e.each(function() {
                        let e = n(this);
    ...
    var u = {
        ...
        initItem: function(e) {
            ...
            e.hasClass("qodef--only-content") && (o = o.map(function(e) {
                return ".elementor " + e
            })), (o = u.prepareHeadings(n, i, o)).length && (o.each(function(e) {
                var o, t, n, i = h(this),
                    d = i.clone(),
                    r = u.prepareId(c, d, l);
                l += r.id + ";", f[e] = {
...
function(e) {
    ...
    var o = {
        ...
        initSwiperReinit: function(e) {
            ...
            n.width(t.width()), n.css("top", t.height()), a = i.find(".swiper-slide").length, (o = d[0].swiper.params).loopedSlides = a, o.autoplay = !1, (n = r[0].swiper.params).grabCursor = !1, n.loopedSlides = a, n.autoplay = !1, n.effect = "fade", n.allowTouchMove = !1, r[0].swiper.update();
            var t = d.data().options.autoplayDelay,
                a = i[0].swiper.autoplay.running;
            i[0].swiper.autoplay.stop(), d[0].swiper.destroy(), r[0].swiper.destroy();
            let s = new Swiper(d, Object.assign(o)),
                l = new Swiper(r, Object.assign(n));
            i[0].swiper.controller.control = s, i[0].swiper.controller.by = "slide", i[0].swiper.controller.inverse = !0, s.controller.control = i[0].swiper, a && ("" != t ? setTimeout(function() {
                i[0].swiper.autoplay.start()
            }, t) : i[0].swiper.autoplay.start()), e.addClass("qodef--visible"), s.on("slideChange", function() {
                var e = s.realIndex;
        ...
        initItem: function(e) {
            !e.hasClass("qodef-item-layout--info-below-swap") || (e = e.find(".qodef-grid-item")).length && e.each(function() {
                var e = d(this),
                    ...
                    t = Math.ceil(Math.max(n, t.height())) + "px";
                e.css({
                    "--qodef-max-width": i,
                    "--qodef-max-height": t
