    ...
    const o = function(t) {
            ...
            if (!t.getAll(this.field).every((t => t instanceof File && this.accept ? .some((e => /^\.[a-z0-9]+$/i.test(e) ? t.name.toLowerCase().endsWith(e.toLowerCase()) : (t => {
                    ...
                    if (i) {
                        ...
                        for (const [s, o] of (() => {
                            ...
                            })())("*" === n && o.startsWith(t + "/") || o === i[0]) && e.push(...s.split("|"))
                    }
                    return e
        ...
        f = function(t) {
            ...
            if (e.forEach((t => {
                ...
                })), 0 !== i && i < parseInt(this.threshold)) throw new s(this)
        },
        u = function(t) {
            const e = t.getAll(this.field);
            let i = 0;
            if (e.forEach((t => {
                    "string" == typeof t && (i += t.length)
                })), parseInt(this.threshold) < i) throw new s(this)
        },
        h = function(t) {
    ...
    window.swv = {
        ...
        validate: (t, i, o = {}) => {
            const a = (t.rules ? ? []).filter((({
                rule: t,
                ...i
            }) => "function" == typeof e[t] && ("function" != typeof e[t].matches || e[t].matches(i, o))));
